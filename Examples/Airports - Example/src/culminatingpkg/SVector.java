...
/**
 * Used as a temporary solution to not having 2D PVectors in Java (as you did in
 * Processing)
 * 
 * @author Mr. Seidel
 * @author M.C.
 ...
 *
 */
// Michael added the compareTo(), dot(), cross(), array(), copy(), magSq(),
// sub() and dist() methods
...
public class SVector {
	...
	/**
	 * Default constructor for the SVector --This constructor uses the (double
	 * x, double y, double z) constructor
	 * 
	 */
	public SVector() {
		this(0, 0, 0);
	...
	/**
	 * Constructor for a 2D SVector --This constructor uses the (double x,
	 * double y, double z) constructor
	 * 
	 * @param x
	 *            the x coordinate for the SVector
	 * @param y
	 *            the y coordinate for the SVector
	 */
	...
	/**
	 * Constructor for the SVector --This constructor uses the (double x, double
	 * y, double z) constructor
	 * 
	 * @param v
	 *            Another SVector
	 */
	 ...
	 * 
	 * @param v
	 *            The SVector to be added to this one
	 ...
	 * 
	 * @param scalar
	 *            The scalar amount to multiply this SVector by
	 ...
	 * 
	 * @param scalar
	 *            The scalar amount to divide this SVector by
	 ...
	 * 
	 * @param v
	 *            the vector needed to be compared to
	 ...
	 * 
	 * @param v
	 *            the input vector used to generate dot product
	 ...
	 * 
	 * @param v
	 *            the input vector used to generate cross product
	 * @return the cross product as a SVector
	 */
	public SVector cross(SVector v) {
		return new SVector(this.y * v.getZ() - this.z * v.getY(), this.z * v.getX() - this.x * v.getZ(),
	...
	/**
	 * This function copies the components of the input vector and returns the
	 * result as a SVector
	 * 
	 * @param v
	 *            the input vector needed to be copied
	...
	/**
	 * This function calculates the angle between an input vector and this
	 * vector
	 * 
	 * @param v
	 *            an input vector to be used to calculate the angle with this
	 *            vector
	 * @return the angle between two vectors (as a double)
	 */
	public double angle(SVector v) {
		return Math.asin(this.dot(v) / this.mag() / v.mag());
	}
}
